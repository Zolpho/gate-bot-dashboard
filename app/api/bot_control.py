...
class InfiniteGridPrepareRequest(BaseModel):
    ...
    profit_per_grid: Decimal = Field(gt=0)

    grid_num: int | None = Field(
        default=None,
        ge=1,
    )

    price_type: Literal[0, 1] | None = None
...
@router.post("/infinite-grid/prepare")
async def prepare_infinite_grid(
